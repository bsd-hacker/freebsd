...
const char *freebsd32_syscallnames[] = {
	...
	"#465",			/* 465 = aio_fsync */
	"#466",			/* 466 = rtprio_thread */
	"#467",			/* 467 = nosys */
	"#468",			/* 468 = nosys */
	"#469",			/* 469 = __getpath_fromfd */
	"#470",			/* 470 = __getpath_fromaddr */
	"#471",			/* 471 = sctp_peeloff */
	"#472",			/* 472 = sctp_generic_sendmsg */
	"#473",			/* 473 = sctp_generic_sendmsg_iov */
	"#474",			/* 474 = sctp_generic_recvmsg */
	"#475",			/* 475 = freebsd32_pread */
	"#476",			/* 476 = freebsd32_pwrite */
	"#477",			/* 477 = freebsd32_mmap */
	"#478",			/* 478 = freebsd32_lseek */
	"#479",			/* 479 = freebsd32_truncate */
	"#480",			/* 480 = freebsd32_ftruncate */
	"#481",			/* 481 = thr_kill2 */
	"#482",			/* 482 = shm_open */
	"#483",			/* 483 = shm_unlink */
	"#484",			/* 484 = cpuset */
	"#485",			/* 485 = freebsd32_cpuset_setid */
	"#486",			/* 486 = freebsd32_cpuset_getid */
	"#487",			/* 487 = freebsd32_cpuset_getaffinity */
	"#488",			/* 488 = freebsd32_cpuset_setaffinity */
	"#489",			/* 489 = faccessat */
	"#490",			/* 490 = fchmodat */
	"#491",			/* 491 = fchownat */
