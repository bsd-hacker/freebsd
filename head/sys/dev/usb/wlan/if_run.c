/*	$FreeBSD: user/eri/pf45/head/sys/dev/usb/wlan/if_run.c 203138 2010-01-28 22:54:01Z thompsa $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: user/eri/pf45/head/sys/dev/usb/wlan/if_run.c 203138 2010-01-28 22:54:01Z thompsa $");
